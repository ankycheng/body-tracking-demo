...
const lerpAmount = 0.05; // Adjust this value between 0 and 1 to control smoothing
let button;
let outfit = false;
...
function draw() {
  ...
  //   targetPose2 
  //   // &&
  //   // abs(getBodyCenter(currentPose2).x - getBodyCenter(currentPose).x) > 100
  // ) 
  // {
  //   push();
...
function drawOutfit1(poseData) {
  ...
  translate(180, -20);
  rotate(PI);
  image(cupImg, -10,-30, scaleFactor * cupImg.width, scaleFactor * cupImg.height);
  pop();
...
function drawOutfit2(poseData) {
  ...
  translate(180, -20);
  rotate(PI);
  image(cupImg, -10,-50, scaleFactor * cupImg.width, scaleFactor * cupImg.height);
  pop();
